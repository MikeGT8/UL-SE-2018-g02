...
the actCoordinators goal is to get the detailed list of existing crisis or alerts to decide on next actions
to undertake.		  
...
\addsinglerow{the actCoordinators goal is to get the detailed list of existing crisis or alerts to decide on next actions
to undertake.}
