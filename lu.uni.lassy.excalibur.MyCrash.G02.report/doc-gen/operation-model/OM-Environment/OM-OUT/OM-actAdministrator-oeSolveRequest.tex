...
The \msrcode{oeSolveRequest} operation has the following properties:
	...
	\adddoublerow{oeSolveRequest}{sent to solve the requested PI in the system’s post state.}
	...
	\addnumberedsinglerow{PreF}{it is supposed that there exists one ctRequest instance with the same id attribute and the status 'treated' than the one the administrator wants to solve.}

	\addrowheading{Post-Condition (functional)}
	\addnumberedsinglerow{PostF}{the request's status is updated to 'solved' in the system.
