...
The \msrcode{oeTreatRequest} operation has the following properties:
	...
	\adddoublerow{oeTreatRequest}{sent to treat the requested PI in the systems post state.}
	...
	\addnumberedsinglerow{PostF}{PostF01 the requests status is updated to treated in the system.}
