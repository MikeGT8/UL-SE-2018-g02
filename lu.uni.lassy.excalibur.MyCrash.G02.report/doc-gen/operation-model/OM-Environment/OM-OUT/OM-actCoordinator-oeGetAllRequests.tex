...
The \msrcode{oeGetAllRequests} operation has the following properties:
	...
	\addnumberedsinglerow{PostF}{the actor ActCoordinator gets a list of requests to handle if there are unhandled requests (no status).
	the coordinator actor is also informed about the non-satisfaction of its request.}
