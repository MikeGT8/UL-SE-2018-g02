...
The \msrcode{oeUpdatePI} operation has the following properties:
	...
	\addnumberedsinglerow{PreF}{it is supposed that there exists one ctPI instance with the same id attribute than the one the administrator wants to delete.}

	\addrowheading{Post-Condition (functional)}
	\addnumberedsinglerow{PostF}{the PI is deleted from the system.
